  ...
  `}
      ...
      <div className="relative flex flex-col items-center mb-6">
        {isRunning && (
          <>
            <Star
              size={12}
              className="absolute -top-6 -left-10 text-yellow-300 animate-sparkle [--tw-translate-x:-30px] [--tw-translate-y:-20px]"
            />
            <Star
              size={10}
              className="absolute top-12 -right-12 text-pink-300 animate-sparkle [--tw-translate-x:25px] [--tw-translate-y:15px]"
            />
            <div
              key={seconds}
              className="absolute -right-14 top-2 text-accent font-black text-sm animate-xp-float"
            >
              +1 XP
            </div>
          </>
      ...
      <div className="w-full flex justify-between px-8 border-b border-containerBorder/50 pb-4">
        <div className="flex flex-col items-start gap-1">
          ...
          <span className="text-xl font-black text-appText leading-none">
            {finishTime || "--:--"}
          </span>
        </div>
    ...
    `}
      ...
      <div className="w-full mb-8 space-y-4 pt-4">
        <div className="text-center p-6 bg-activeTaskBg/20 rounded-[35px] border border-containerBorder/20 min-h-[5.5rem] flex items-center justify-center relative overflow-hidden shadow-[0_2px_2px_var(--shadow-color)]">
          <p className="text-lg font-bold text-appText leading-tight italic z-10">
            <Sparkles
              size={16}
              className={`inline mr-2 text-accent ${isRunning ? "animate-pulse" : ""}`}
            />
        ...
        {nextStep && (
          ...
          <div className="px-6 py-4 bg-activeTaskBg/10 rounded-[30px] border border-dashed border-containerBorder/30 transition-all duration-500">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-[9px] font-black text-accent uppercase tracking-[0.2em] opacity-50">
                NEXT UP:
              </span>
      ...
      <div className="w-full bg-activeTaskBg/40 p-3 rounded-full border border-containerBorder shadow-inner flex items-center justify-between px-6">
        ...
        <button
          ...
          className="p-2 text-accentMuted/30 hover:text-accent transition-colors"
        >
          <RefreshCw size={20} />
        </button>
